...
<head>
    ...
    <script type="text/javascript" src="${MYFILE_PREFIX_MAP.COMM_JS}/WeAdmin/lib/layui/layui.js" charset="utf-8"></script>
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child">
                ...
                <dd>
                    <a class="loginout" href="login?quitLogin=true">退出</a>
                </dd>
            </dl>
        </li>
    ...
    <div class="layui-tab tab" lay-filter="wenav_tab" id="WeTabTip" lay-allowclose="true">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
               <%-- <iframe src='${MYFILE_PREFIX_MAP.COMM_JS}/WeAdmin/pages/welcome.html' frameborder="0" scrolling="yes" class="weIframe"></iframe>--%>
...
<script type="text/javascript">
    ...
    //			});
    layui.config({
        base: '${MYFILE_PREFIX_MAP.COMM_JS}/WeAdmin/static/js/'
        ,version: '101100'
    }).use('admin');
